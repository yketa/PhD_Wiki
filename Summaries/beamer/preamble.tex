...
\makeatletter
\let\insertcollaborator\relax
\newcommand\collaboratortitle{in collaboration with}
\mode<all>
{
  \newcommand\collaborator[1]{\def\insertcollaborator{#1}}
  \titlegraphic{}
}
...
\defbeamertemplate*{title page}{supdefault}[1][]
{
  ...
  \begingroup
    ...
    \vspace{-10pt}
    \begin{beamercolorbox}[sep=8pt,center,#1]{author}
      \usebeamerfont{author}{\footnotesize \collaboratortitle}~{\small\insertcollaborator}
